...
Original file is located at
    https://colab.research.google.com/drive/1J3AxMZW1CxUk787kQBd0Eu9Dk1jLKr8B
"""

from google.colab import files
src = list(files.upload().values())[0]
open('agent.py','wb').write(src)
open('basic_buffer.py','wb').write(src)
open('flipped_agent.py','wb').write(src)
open('kotra.py','wb').write(src)
open('pubeval.py','wb').write(src)
open('randomAgent.py','wb').write(src)
